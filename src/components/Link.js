...
class Link extends Component {
    ...
    render() {
        ...
        return (
            <div className='flex mt2 items-start'>
                ...
                <div className='ml1'>
                    <div>{this.props.link.description} <span className='gray'> ({this.props.link.url})</span></div>
    ...
    _voteForLink = async () => {
        ...
        await this.props.createVoteMutation({
            ...
            // Quick note: store is the current cache as arguments, data is the mutation payload {createVote: {...}}
